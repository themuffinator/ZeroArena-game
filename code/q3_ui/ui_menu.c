...
static void Main_MenuDraw( void ) {
	...
	if (uis.demoversion) {
		UI_DrawProportionalString( 320, 372, "DEMO      FOR MATURE AUDIENCES      DEMO", UI_CENTER| UI_TINYFONT, color );
		UI_DrawString( 320, 460, "Quake III Arena(c) 1999-2000, Id Software, Inc.  All Rights Reserved", UI_CENTER|UI_TINYFONT, color );
	} else {
		UI_DrawString( 320, 460, "Quake III Arena(c) 1999-2000, Id Software, Inc.  All Rights Reserved", UI_CENTER| UI_TINYFONT, color );
	}
}
